...
MODEL                   = SpaceRendezvousAndDockingExample
MODULES                 = SpaceRendezvousAndDockingExample.c SpaceRendezvousAndDockingExample_capi.c SpaceRendezvousAndDockingExample_data.c SpaceRendezvousAndDockingExample_tgtconn.c rtGetInf.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = SpaceRendezvousAndDockingExample.exe
MAKEFILE                = SpaceRendezvousAndDockingExample.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2024b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2024b
START_DIR               = C:\Users\Ameya\Documents\IITBSSP\DOCKING\SpaceRendezvousAndDockingExample
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 27
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SpaceRendezvousAndDockingExample_ref.rsp
COMPILER_COMMAND_FILE     = SpaceRendezvousAndDockingExample_comp.rsp
